...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","C:\\projetos\\viewerhar");
    parameters.put("artifactId","viewerhar");
    parameters.put("outputDirectory","C:\\projetos\\viewerhar\\target\\classes");
    parameters.put("testOutputDirectory","C:\\projetos\\viewerhar\\target\\test-classes");
